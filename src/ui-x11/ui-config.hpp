...
#define BWIDGETS_DEFAULT_IMAGE_WIDTH 200
#define BWIDGETS_DEFAULT_IMAGE_HEIGHT 100
...
constexpr int UI_OSC_WAVEFORM_IMAGE_X = 715;
constexpr int UI_OSC_WAVEFORM_IMAGE_Y = 30;
...
constexpr int UI_LFO_WAVEFORM_IMAGE_X = 700;
constexpr int UI_LFO_WAVEFORM_IMAGE_Y = 35;
